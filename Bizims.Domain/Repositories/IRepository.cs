...
public interface IRepository<TEntityModel>
{
    ...
    Task<IReadOnlyList<TEntityModel>> FindAllByAsync(System.Linq.Expressions.Expression<Func<TEntityModel, bool>> condition, Func<IQueryable<TEntityModel>, IQueryable<TEntityModel>> extendQuery);
    Task<TEntityModel?> FindByAsync(System.Linq.Expressions.Expression<Func<TEntityModel, bool>> condition);
    Task<TEntityModel?> FindByAsync(System.Linq.Expressions.Expression<Func<TEntityModel, bool>> condition, Func<IQueryable<TEntityModel>, IQueryable<TEntityModel>> extendQuery);
